...
return new class extends Migration
{
    ...
    {
        $defaultInvoiceEmailBody = 'You have received a new invoice from <b>{COMPANY_NAME}</b>.</br> The PDF is attached to this email.';
        $defaultEstimateEmailBody = 'You have received a new quotation from <b>{COMPANY_NAME}</b>.</br> The PDF is attached to this email.';
        $defaultPaymentEmailBody = 'Thank you for the payment.</br> The payment receipt PDF is attached to this email.';
