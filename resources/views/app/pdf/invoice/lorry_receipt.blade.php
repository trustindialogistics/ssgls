...
<div class="sheet">
    ...
    @endphp
    <div class="t" style="left:22pt; top:438pt;">Paid to Shri</div><div class="line" style="left:72pt; top:437pt; width:160pt; {{ $getFontForWidth($paidToVal, 160) }}">{{ $paidToVal }}</div><div class="t" style="left:235pt; top:438pt;">Lorry Hire (Rate X Wt.)</div><div class="t r" style="left:305pt; top:454pt; width:92pt;">Add Other Charges</div><div class="t" style="left:22pt; top:476pt;">Gross Hire Rupees</div><div class="line" style="left:95pt; top:475pt; width:250pt;">{{ $grossHireRupeesOnly }}</div><div class="t" style="left:348pt; top:476pt;">Only</div><div class="t" style="left:22pt; top:490pt;">Advance Paid by Cash/Cheque No.</div><div class="line" style="left:156pt; top:489pt; width:52pt;">{{ $v(['Advance Paid by Cash/Cheque No', 'Advance Cash Cheque No']) }}</div><div class="t" style="left:212pt; top:490pt;">On</div><div class="line" style="left:225pt; top:489pt; width:55pt;">{{ $v('Advance On') }}</div><div class="t" style="left:284pt; top:490pt;">Bank</div><div class="line" style="left:307pt; top:489pt; width:95pt; {{ $getFontForWidth($v(['Bank', 'Advance Bank']), 95) }}">{{ $v(['Bank', 'Advance Bank']) }}</div><div class="t" style="left:22pt; top:503pt;">Balance Payable at</div><div class="line" style="left:95pt; top:502pt; width:115pt;">{{ $v(['Balance Payable at', 'Balance Payable At']) }}</div><div class="t" style="left:218pt; top:503pt;">Rupees</div><div class="line" style="left:251pt; top:502pt; width:80pt;">{{ $balanceAmount }}</div><div class="line" style="left:22pt; top:517pt; width:328pt;">{{ preg_replace('/(?:\s+only)+$/i', '', (string) $balanceRupeesOnly) }}</div><div class="t" style="left:350pt; top:517pt;">Only</div>
