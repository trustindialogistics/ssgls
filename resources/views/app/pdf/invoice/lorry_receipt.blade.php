...
<div class="sheet">
    ...
    <div class="t c b" style="left:286pt; top:98pt; width:61pt; font-size:8.5pt;">{{ $invoice->invoice_number }}</div>
    <div class="t c b" style="left:351pt; top:98pt; width:43pt; font-size:8.5pt;">{{ $v('No Of Pages') }}</div>
    <div class="t c b" style="left:398pt; top:98pt; width:58pt; font-size:8.5pt;">{{ $v('No Of Packages') }}</div>
    <div class="t c b" style="left:459pt; top:75pt; width:60pt; font-size:7pt;">{{ $v('Actual Weight') }}</div>
    <div class="t c b" style="left:459pt; top:110pt; width:60pt; font-size:7pt;">{{ $v('Charge Weight') }}</div>
    ...
    @endphp
    <div class="t" style="left:22pt; top:626pt;">Paid to shri</div><div class="line" style="left:75pt; top:625pt; width:350pt;">{{ $finalPaidToVal }}</div>
