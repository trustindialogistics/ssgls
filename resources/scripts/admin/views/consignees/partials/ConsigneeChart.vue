  ...
  <BaseCard class="flex flex-col mt-6">
    ...
    <div class="pt-6 mt-6 border-t border-gray-200 border-solid">
      <div class="flex flex-col gap-4 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <BaseHeading>Consignee Transactions</BaseHeading>
...
<script setup>
import CustomerInfo from '../../customers/partials/CustomerInfo.vue'
...
import ChartPlaceholder from '../../customers/partials/CustomerChartPlaceholder.vue'
...
// Consignees don't have expenses, so return 0
