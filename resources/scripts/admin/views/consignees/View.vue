<template>
  <BasePage class="xl:pl-96">
    <BasePageHeader :title="pageTitle">
      <template #actions>
        <router-link
          ...
          :to="`/admin/consignees/${route.params.id}/edit`"
        >
          <BaseButton
            class="mr-3"
    ...
    <!-- Consignee View Sidebar -->
    <ConsigneeViewSidebar />
...
<script setup>
import ConsigneeViewSidebar from './partials/ConsigneeViewSidebar.vue'
import ConsigneeChart from './partials/ConsigneeChart.vue'
