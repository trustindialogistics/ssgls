          ...
          <BaseInputGrid class="col-span-5 lg:col-span-4">
            <template v-if="type === 'OWNER'">
              ...
              <div class="col-span-5 mt-4 mb-2">
                <h6 class="text-base font-semibold text-gray-700">Mandatory Required Documents</h6>
              </div>
...
const emptyForm = {
  ...
  // Document fields for Owner
  rc_front_path: '',
  rc_back_path: '',
  pan_front_path: '',
  insurance_path: '',
  // Document fields for Driver
  license_front_path: '',
  license_back_path: '',
  // Document fields for Broker
