...
class ExpensesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $expenses = Expense::with(['category', 'fields.customField', 'customer', 'paymentMethod', 'currency', 'media'])
            ->whereCompany()
    ...
    public function store(ExpenseRequest $request)
    {
        ...
        return new ExpenseResource($expense->load(['category', 'fields.customField', 'customer', 'paymentMethod', 'currency', 'media']));
    }
